...
var ScenarioWorld = exports.ScenarioWorld = /*#__PURE__*/function (_World) {
  function ScenarioWorld(options) {
    ...
    _defineProperty(_this, "globalConfig", void 0);
    _defineProperty(_this, "globalVariables", void 0);
    _defineProperty(_this, "screen", void 0);
    _defineProperty(_this, "newBrowser", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return browserType.launch({
              // headless: process.env.HEADLESS !== 'false', to run in headless mode
